...
@section('content')
    ...
    <div x-data="{ showModal: false }">
            ...
            <button type="button" @click="showModal = true"
               ...
               hover:bg-primary-700 transition cursor-pointer">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    stroke="currentColor" stroke-width="1" class="bi bi-plus" viewBox="0 0 16 16">
                    <path
        ...
        <div class="bg-white rounded-2xl border border-slate-200 overflow-hidden">
            ...
            -<div class="flex items-center gap-3 px-5 py-4 border-b border-slate-100">
                ...
                @if (request()->hasAny(['busca_id', 'busca_nome', 'busca_telefone', 'busca_email', 'busca_cpf', 'busca_nasc']))
                    <a href="{{ route('cliente.index') }}"
                        class="ml-auto text-xs text-slate-400 hover:text-red-500 transition">
                        ✕ Limpar filtros
                    </a>
                @endif
            </div>
                        ...
                        <thead>
                            ...
                            <tr class="bg-slate-50 border-b border-slate-100">
                                ...
                                <th
                                    ...
                                    Nome</th>
                                <th
                                    class="text-left text-[11px] font-bold text-slate-400 uppercase tracking-wide px-4 py-3">
                                    Telefone</th>
                                <th
                                    class="text-left text-[11px] font-bold text-slate-400 uppercase tracking-wide px-4 py-3">
                                    E-mail</th>
            ...
            <br>
            <div class="mt-6">
                {{ $dados->appends(request()->query())->links('vendor.pagination.tailwind') }}
            </div>
        </div>{{-- fim do painel --}}
