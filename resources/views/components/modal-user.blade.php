        ...
        <div @click.stop class="bg-slate-50 rounded-2xl shadow-xl border-2 border-primary-400 p-6 sm:p-7"
            ...
            <div class="space-y-4">
                <form id="cliente-form" method="POST"
                    :action="modal.mode === 'create' ?
                        '{{ route('cliente.store') }}' :
                        '{{ route('cliente.update', ['cliente' => '__ID__']) }}'.replace('__ID__', modal.data.id ?? '')">
                    @csrf
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" name="nome" x-model="modal.data.nome"
                                :readonly="modal.mode === 'view'" placeholder="Digite o nome do cliente"
                        ...
                        <div>
                            ...
                            <input type="text" name="telefone" x-model="modal.data.telefone"
                                :readonly="modal.mode === 'view'" placeholder="(00) 00000-0000"
                                class="w-full border border-gray-200 rounded-lg px-3 py-2.5 text-sm placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 disabled:bg-gray-50 disabled:text-gray-500">
                        </div>

                        <div>
                            <label class="block text-xs font-medium text-gray-700 mb-1.5">CPF</label>
                            <input type="text" name="cpf" x-model="modal.data.cpf"
                                :readonly="modal.mode === 'view'" placeholder="000.000.000-00"
                                class="w-full border border-gray-200 rounded-lg px-3 py-2.5 text-sm placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 disabled:bg-gray-50 disabled:text-gray-500">
                        </div>

                        <div>
                            <label class="block text-xs font-medium text-gray-700 mb-1.5">E-mail</label>
                            <input type="text" name="email" x-model="modal.data.email"
                                :readonly="modal.mode === 'view'" placeholder="cliente@exemplo.com"
                                class="w-full border border-gray-200 rounded-lg px-3 py-2.5 text-sm placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 disabled:bg-gray-50 disabled:text-gray-500">
                        </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="dt_nascimento" x-model="modal.data.dt_nascimento"
            ...
            <div class="flex justify-end gap-2 mt-8 pt-1">
                ...
                <button x-show="modal.mode !== 'view'"
                    ...
                    x-text="modal.mode === 'create' ? 'Salvar' : 'Atualizar'" type="submit"
                    form="cliente-form"></button>
